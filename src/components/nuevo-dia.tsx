...
export default function NuevoDia() {
  ...
  return (
    <form className={layout.nuevoDia} onSubmit={handleSubmit(
      onSubmit
    )}>
      <fieldset className={layout.name}>
        <legend className={typeface.title}>Base</legend>
        <input
          type="week"
          placeholder="Semana"
          {...register(
      ...
      <section className={layout.main}>
        <fieldset className={box.container}>
          <legend className={typeface.title}>Urgencia</legend>
          <h3>Ganas de colgar los guayos</h3>
          <select id="suicidarme" {...register(
            "urgencia.suicidarme"
          )}>
          ...
          <br></br>
          <h3>Ganas de hacer conductas de riesgo</h3>
          <select
            id="conductasRiesgo"
            {...register(
        ...
        <fieldset className={box.container}>
          <legend className={typeface.title}>Sufrimiento</legend>
        ...
        <fieldset className={box.grid}>
          <legend className={typeface.title}>Conductas de Riesgo</legend>
